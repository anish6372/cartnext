...
import { FaShippingFast, FaUndoAlt, FaLock, FaHeadset, FaCcVisa, FaCcMastercard, FaCcPaypal, FaCcAmex } from "react-icons/fa";
...
const Layout = ({ children }) => {
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <div className="bg-red-600 text-white text-sm py-2 px-4 flex flex-wrap justify-between items-center">
        ...
        <span className="text-center">Free shipping for all orders of $50+</span>
        <div className="flex gap-4 flex-wrap">
  ...
  <div className="flex justify-between items-center">
    <div className="container mx-auto flex flex-wrap justify-start gap-6 ms-4">
      <span>HOME</span>
      <span>SHOP</span>
      <span>WOMEN</span>
      <span>MEN</span>
    ...
    <div className="flex items-center bg-red-600 text-white px-6 py-2 rounded mr-20 gap-2">
  <span className="whitespace-nowrap">Get 30% Discount Now</span>
  <span className="bg-amber-100 text-black px-2 py-1 rounded-xl text-sm">SALE</span>
</div>
  </div>
</nav>
      ...
      {(isCartPage || isProductDetailsPage) && (
        <section className="bg-pink-100 py-20">
          <div className="container mx-auto flex justify-between items-center px-4 space-x-0">
            <h2 className="text-3xl font-bold ">
              {isCartPage ? "Cart Page" : "Product Details"}
            </h2>
            <p className="text-sm text-gray-700">Home &gt; {isCartPage ? "Cart Page" : "Product Details"}</p>
          </div>
        </section>
      )}
    </header>
      ...
      <footer className="bg-gray-100 text-gray-700 py-10 border-t w-full mt-12">
        <div className="px-6 lg:px-20">
          ...
          <div className="mt-8 text-center flex justify-between border-t">
            <div className="flex justify-evenly">
              <p className="text-sm mt-6 me-4">Payment System:</p>
